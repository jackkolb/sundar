# gitcheck.py: contains functions for periodically checking GitHub for updates
import subprocess  # used to run "git pull"
import time  # used to delay between pulling from GitHub
